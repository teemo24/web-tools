...
$auth_users = array(
    'admin' => '$1$MUBfWYp2$iYLvXUAcO/eyhZ36crwPr0', //3.s......7mema
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                                    ...
                                    <div class="form-group">
                                       <div class="brand">
                                        ...
                                        <div class="text-center">
                                            <h1 class="card-title"><?php echo "File Manager" ?></h1>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="form-group">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="#" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Teemo</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <p>Author: Teemo</p>
                        <p>Mail Us: <a href="mailto:startx@live.fr">startx@live.fr</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        ...
                        <?php if(strtolower(pathinfo($f, PATHINFO_EXTENSION)) == 'zip'){ ?>
                            <a title="<?php echo lng('Unzip') ?>" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;unzip=<?php echo urlencode($f) ?>"><i style="color:white" class="fa fa-file-archive-o"></i></a>
                        <?php } ?>
                    </td>
                </tr>
                <?php
                ...
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            <a title="<?php echo lng('phpMyAdmin') ?>" class="dropdown-item nav-link" href="./phpmyadmin" target="_blank"><i class="fa fa-database" aria-hidden="true"></i> <?php echo lng('phpmyadmin') ?></a>
                            <?php if (!FM_READONLY): ?>
